...
from logicnn import MLPDropout, LogisticRegression, LeNetConvPoolLayer, LogicNN, DropoutHiddenLayer
...
if __name__=="__main__":
    ...
    print ("loading data...")
    x = pickle.load(open("data/logicnn/stsa.binary.p","rb"))
    revs, W, W2, word_idx_map, vocab = x[0], x[1], x[2], x[3], x[4]

    print ("data loaded!")
    print ("loading features...")
    fea = pickle.load(open("data/logicnn/stsa.binary.p.fea.p","rb"))
